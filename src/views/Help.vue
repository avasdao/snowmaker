    ...
    <main class="bg-white">
        ...
        <div class="relative pb-32 bg-gray-800">
            ...
            <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                ...
                <p class="mt-6 max-w-3xl text-xl text-gray-300">
                    Snowmaker is a FULLY decentralized platform.
                ...
                <div class="flex flex-col bg-white rounded-2xl shadow-xl">
                    <div class="flex-1 relative pt-16 px-6 pb-8 md:px-8">
                        ...
                        <p class="mt-4 text-base text-gray-500">
                            Our Reddit sub (<a class="text-red-400 font-medium" href="https://www.reddit.com/r/Snowmaker/" target="_blank">/Snowmaker</a>) is the best place to go to get the most up-to-date information on this project.
                        </p>
                    </div>

                    <div class="p-6 bg-gray-50 rounded-bl-2xl rounded-br-2xl md:px-8">
                        <a href="https://www.reddit.com/r/Snowmaker/" target="_blank" class="text-base font-medium text-indigo-700 hover:text-indigo-600">Contact us<span aria-hidden="true"> &rarr;</span></a>
                    </div>
                </div>
        ...
        <section class="mt-20 bg-white pb-16 px-4 overflow-hidden sm:px-6 lg:px-8 lg:pb-24">
            <div class="relative max-w-xl mx-auto">
                ...
                <div class="mt-12">
                    <form action="javascript://" method="POST" class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                        <div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <p class="text-base text-gray-500">
                                        ...
                                        <a href="javascript://" class="font-medium text-gray-700 underline">Privacy Policy</a>
                                        and
                                        <a href="javascript://" class="font-medium text-gray-700 underline">Cookie Policy</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
