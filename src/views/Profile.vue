                ...
                <div class="flex justify-between h-16">
                    <div class="flex px-2 lg:px-0">
                        ...
                        <nav aria-label="Global" class="hidden lg:ml-6 lg:flex lg:items-center lg:space-x-4">
                            <a href="javascript://" class="px-3 py-2 text-gray-900 text-sm font-medium">
                                Dashboard
                            </a>
                            ...
                            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y divide-gray-200">
                                <div class="pt-3 pb-2">
                                    ...
                                    <div class="mt-3 px-2 space-y-1">
                                        <a href="javascript://" class="block rounded-md px-3 py-2 text-base text-gray-900 font-medium hover:bg-gray-100 hover:text-gray-800">Dashboard</a>

                                        <a href="javascript://" class="block rounded-md px-3 py-2 text-base text-gray-900 font-medium hover:bg-gray-100 hover:text-gray-800">Jobs</a>

                                        <a href="javascript://" class="block rounded-md px-3 py-2 text-base text-gray-900 font-medium hover:bg-gray-100 hover:text-gray-800">Applicants</a>

                                        <a href="javascript://" class="block rounded-md px-3 py-2 text-base text-gray-900 font-medium hover:bg-gray-100 hover:text-gray-800">Company</a>
                                    </div>
                                </div>
                                <div class="pt-4 pb-2">
                ...
                <div class="border-t border-gray-200 py-3">
                    <nav class="flex" aria-label="Breadcrumb">
                        <div class="flex sm:hidden">
                            <a href="javascript://" class="group inline-flex space-x-3 text-sm font-medium text-gray-500 hover:text-gray-700">
                            ...
                            <ol role="list" class="flex items-center space-x-4">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="javascript://" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Jobs</a>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="javascript://" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Front End Developer</a>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="javascript://" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">Applicants</a>
                                    </div>
                                </li>
                            </ol>
                        </div>
...
<script>
/* Import components. */
import Notes from './Profile/Notes.vue'
