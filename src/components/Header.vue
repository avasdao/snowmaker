<template>
    <main>
        <div class="relative bg-white">
            <div class="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
                ...
                <nav class="hidden">
                    <div class="relative">
                        ...
                        <button
                            @click="showSBCHMenu = !showSBCHMenu"
                            type="button"
            ...
            -->
                        <div v-if="showSBCHMenu" class="absolute z-10 -ml-4 mt-3 transform w-screen max-w-md lg:max-w-2xl lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                                    <a href="javascript://" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">
                                                Learn more about smartBCH technology and the team behind the project.
                                            </p>
                                        </div>
                                    </a>
                                    ...
                                    <a href="javascript://" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">
                                                Search for transaction and block details plus more advanced features.
                                            </p>
                                        </div>
                                    </a>
                                    ...
                                    <a href="javascript://" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">
                                                A quick introduction to Smart Bitcoin and getting your first sBCH.
                                            </p>
                                        </div>
                                    </a>
                                    ...
                                    <a href="javascript://" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">
                                                Get anwsers to the most commonly asked questions from community experts.
                                            </p>
                                        </div>
                                    </a>
                                </div>
                ...
                <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                    <div class="pt-5 pb-6 px-5">
                        ...
                        <div class="mt-6">
                            <nav class="grid grid-cols-1 gap-7">
                                <a href="javascript://" class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50">
                    ...
                    <div class="py-6 px-5">
                        <div class="grid grid-cols-2 gap-4">
                            <a href="javascript://" class="text-base font-medium text-gray-900 hover:text-gray-700">
                                Pricing
                            </a>
                            <a href="javascript://" class="text-base font-medium text-gray-900 hover:text-gray-700">
                                Partners
                        ...
                        <div class="mt-6">
                            ...
                            <p class="mt-6 text-center text-base font-medium text-gray-500">
                                Existing customer?
                                <a href="javascript://" class="text-gray-900">
                                    Sign in
                                </a>
                            </p>
                        </div>
